...
//*************************** Select Class Methods ***************************************//
    ...
    /*
    This method will find out that user exist in the list or not
     */
    public void isUserExistInList(WebElement userList,String userName){
        ...
        for (WebElement oneUser:allUsersExist ) {
            ...
            isUserThere = userInformation.contains(userName);
            if (isUserThere) {
    ...
    // This method will find the username and tick that check box and delete

    public void deleteUserExistInList(WebElement userList,String userName)  {
        List<WebElement> allUsersExist = driver.findElements(By.xpath("//tr[@class='odd'  or 'even']"));
        int no=   allUsersExist.size();
        boolean isUserThere=false;
        System.out.println(no);
